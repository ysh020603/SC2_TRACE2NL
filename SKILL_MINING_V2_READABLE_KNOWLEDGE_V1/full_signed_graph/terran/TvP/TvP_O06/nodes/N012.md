# N012 — Default response to air posture
...
Enemy Intelligence is consistent with a air posture; representative observed or remembered cues may include Zealot, Stalker, Tempest. Production appears heavy, technology investment appears heavy, and exact hidden counts remain unknown. Strengthen air while keeping production on a continue course and economy on a increase course; reconcile the exact choice with the live observation.
...
The human response evidence contains broad investment involving Marine, Reaper, Hellion, Battlecruiser, Medivac; retain its statistical sign without copying an action sequence.
...
**Human-trajectory candidate pool (not an ordered build list):** Marine, Reaper, Hellion, Battlecruiser, Medivac, SiegeTank, Banshee, Marauder
