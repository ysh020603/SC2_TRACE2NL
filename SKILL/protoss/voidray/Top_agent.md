...
## Applicability
This skill is designed for Protoss against Zerg.
Base family: `voidray` / archetype `voidray`.

## Core Objective
Play voidray as Protoss vs Zerg, adapting the next 60–120s macro queue to observable enemy style tags.
...
1. If Opponent looks like standard macro.
   ...
   - Evidence: n=1647, wr=0.4802671523982999, grade=A
2. If Opponent commits Factory ground or Roach-style composition.
   ...
   - Evidence: n=935, wr=0.558288770053476, grade=A
3. If Opponent is expanding quickly with lower immediate pressure.
   ...
   - Evidence: n=812, wr=0.4926108374384236, grade=A
4. If Opponent invests in early static defense.
   - Favor efficient tech/units that beat static lines; keep expanding if safe.
   - Do not mirror unnecessary static defense.
   - Evidence: n=776, wr=0.5257731958762887, grade=A
5. If Opponent shows one-base high production pressure.
   ...
   - Evidence: n=71, wr=0.352112676056338, grade=C
