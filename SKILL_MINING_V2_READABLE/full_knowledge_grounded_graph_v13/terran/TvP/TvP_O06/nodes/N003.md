# N003 — Default response to ground posture
...
Enemy Intelligence is consistent with a ground posture; representative observed or remembered cues may include WarpPrism. Production appears heavy, technology investment appears heavy, and exact hidden counts remain unknown. Strengthen ground while keeping production on a maintain course and economy on a increase course; reconcile the exact choice with the live observation.
...
The human response evidence contains broad investment involving SiegeTank, Marine, Marauder, SupplyDepot, WidowMine; retain its statistical sign without copying an action sequence.
