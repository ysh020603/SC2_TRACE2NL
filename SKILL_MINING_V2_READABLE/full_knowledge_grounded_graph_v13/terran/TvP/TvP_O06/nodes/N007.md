...
The human response evidence contains broad investment involving SiegeTank, Marine, Reaper, Battlecruiser, Marauder; retain its statistical sign without copying an action sequence.
...
**Human-trajectory candidate pool (not an ordered build list):** SiegeTank, Marine, Reaper, Battlecruiser, Marauder, WidowMine, Hellion
