...
Semantically aligned validated knowledge node: `N003` (alignment score 0.107). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.
