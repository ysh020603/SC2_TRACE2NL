# N007 — Late-Midgame Ground with Medivacs
...
Late-midgame, own ground macro with Siege Tanks, Marines, Marauders, and Medivacs, opponent ground posture with Stalkers and Immortals. Maintain ground strength, continue production and tech, and keep economy and expansion heavy.

## When This Applies

### Opponent cues

- Enemy Intelligence shows a ground posture with Stalkers, Observer, and Immortals; production and tech are heavy.
- Treat remembered or observed Enemy Intelligence as partial and uncertain.

### Own cues

- Ground-oriented with heavy production and tech; representative units include Siege Tanks, Marines, Marauders, and Medivacs. Air presence is moderate.
...
Medivacs provide healing and mobility, making the ground army more sustainable in engagements.
...
Prepare for late-game engagements with a well-rounded army.

## Knowledge Constraint Overlay

Semantically aligned validated knowledge node: `N007` (alignment score 0.099). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.
