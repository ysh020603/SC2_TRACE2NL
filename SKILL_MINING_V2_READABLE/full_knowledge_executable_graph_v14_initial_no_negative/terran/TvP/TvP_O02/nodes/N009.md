...
Semantically aligned validated knowledge node: `N012` (alignment score 0.165). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.

### Human-Trajectory Interpretation

The human response evidence contains broad investment involving Marine, SupplyDepot, EngineeringBay, SiegeTank, Marauder; retain its statistical sign without copying an action sequence.
