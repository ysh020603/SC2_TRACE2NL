...
Semantically aligned validated knowledge node: `N006` (alignment score 0.141). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.
