...
Semantically aligned validated knowledge node: `N009` (alignment score 0.246). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.
