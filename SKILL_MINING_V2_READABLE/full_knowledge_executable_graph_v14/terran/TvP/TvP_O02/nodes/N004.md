...
Semantically aligned validated knowledge node: `N002` (alignment score 0.148). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.
