...
Semantically aligned validated knowledge node: `N011` (alignment score 0.134). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.

### Human-Trajectory Interpretation

The human response evidence contains broad investment involving SiegeTank, Marine, Reaper, Battlecruiser, Medivac; retain its statistical sign without copying an action sequence.
...
**Human-trajectory candidate pool (not an ordered build list):** SiegeTank, Marine, Reaper, Battlecruiser, Medivac, Banshee, Marauder
