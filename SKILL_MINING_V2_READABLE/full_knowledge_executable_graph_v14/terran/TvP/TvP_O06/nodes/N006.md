...
Semantically aligned validated knowledge node: `N001` (alignment score 0.059). The executable policy above remains primary; use this overlay only for factual feasibility, candidate selection, and repair checks.
